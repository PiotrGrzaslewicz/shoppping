                    ...
                    <div class="container">
                        ...
                        <div class="card shadow mb-4 border-left-0 border-bottom-0 border-right-0 border-top-0 bg-gray-700">
                            ...
                            <a  class="d-block card-header py-3 bg-gray-900 border-bottom-0">
                                <h6>Witaj ${user.name}</h6>
                                <h6 class="m-0 font-weight-bold text-white">Wprowadź nowe hasło</h6>
                            </a>
                            ...
                            <div class="collapse show" id="coll2">
                                <div class="card-body text-gray-100"
                                    ...
                                    <div class="">
                                        ...
                                        <form class="user" action="${pageContext.request.contextPath}/resetPasswordConfirmed" method="post">

                                            <div class="form-group">
                                                <label for="password">Hasło</label>
                                                <input type="password" class="form-control bg-light border-0 small" id="password"  name="password">
                                            </div>
                                            <div class="form-group">
                                                <label for="repassword">Hasło</label>
                                                <input type="password" class="form-control bg-light border-0 small" id="repassword"  name="repassword">
                                            </div>
