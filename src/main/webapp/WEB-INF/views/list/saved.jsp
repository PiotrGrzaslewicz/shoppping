            ...
            <nav class="navbar navbar-expand navbar-light bg-gray-900 topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid justify-content-between">
                    ...
                    <div class="flex-row">
                        ...
                        <h3 class="font-weight-bold text-gray-500">Zapisane listy</h3>
                    </div>
                            ...
                            <div class="card shadow mb-4 border-left-0 border-bottom-0 border-right-0 border-top-0 bg-gray-700">
                                ...
                                <a href="#a${list.value}"
                                   ...
                                   aria-controls="collapseCardExample">
                                    <div><h4 class="m-0 font-weight-bold text-white">${list.key.name}</h4></div>
                                    <div><h7 class="m-0 font-weight-bold text-white">Utworzono ${list.key.date}</h7>
                                    </div>

                                </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse" id="a${list.value}">
                                    ...
                                    <div class="card-body text-gray-100 "
                                        ...
                                        <div>
                                            ...
                                            <a href="/list/loadlist/${list.key.id}"
                                               class="btn btn-info btn-sm btn-icon-split">
                                                 <span class="icon text-white-50">
                                                    <i class="fas fa-folder-open"></i>
                                                 </span>
                                                <span class="text">Załaduj listę</span>
                                            </a>

                                        </div>
                                        <div>

                                            <a href="/list/delete/${list.key.id}"
                                               class="btn btn-danger btn-sm btn-icon-split">
                                                 <span class="icon text-white-50">
                                                    <i class="fas fa-trash"></i>
                                                 </span>
                                                <span class="text">Usuń listę</span>
                                            </a>
