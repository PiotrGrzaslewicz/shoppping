            ...
            <nav class="navbar navbar-expand navbar-light bg-gray-900 topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid justify-content-between">
                    ...
                    <div class="flex-row">
                        ...
                        <h3 class="font-weight-bold text-gray-500">Usuwanie listy</h3>
                    </div>
                        ...
                        <div class="container">
                            <div class="card shadow mb-4 border-left-0 border-bottom-0 border-right-0 border-top-0 bg-gray-700">
                                ...
                                <div
                                   ...
                                   >
                                    <div>
                                        <h4 class="text-danger ">Potwierdź usunięcie listy</h4>
                                    </div>
                                    <div><h4 class="m-0 font-weight-bold text-white">${list.name}</h4></div>
                                    <div><h7 class="m-0 font-weight-bold text-white">Utworzono ${list.date}</h7>
                                    </div>
                                ...
                                <!-- Card Content - Collapse -->
                                    ...
                                    <div class="card-body text-gray-100 "
                                        ...
                                        <div>
                                            ...
                                            <a href="/list/confirmdelete/${list.id}"
