        ...
        <div class="row ">
          ...
          <div class="container">
            ...
            <div class="card shadow mb-4 border-left-0 border-bottom-0 border-right-0 border-top-0 bg-gray-700">
              ...
              >
                <h6 class="m-0 font-weight-bold text-white">Zmiana hasła</h6>
              </a>
              ...
              <div class="collapse show" id="coll2">
                <div class="card-body text-gray-100"
                  ...
                  <div class="">
                    ...
                    <form class="user" action="/user/changepassword" method="post">

                      <div class="form-group">

                        <input type="password" class="form-control bg-light border-0 small"
                               placeholder="Stare hasło" name="oldPassword" required="true"/>
                      </div>
                      <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                          <input  type="password" class="form-control bg-light border-0 small"
                                  required="true" placeholder="Nowe hasło" name="password"/>
                        </div>
                        <div class="col-sm-6">
                          <input type="password" class="form-control bg-light border-0 small"
                                 placeholder="Powtórz nowe hasło" required="true" name="repassword">
                        </div>
                      </div>
                      <div class="input-group-append">
                        <button class="btn btn-warning" type="submit">
                          <i class="far fa-edit fa-sm"></i> Zmień hasło
                        </button>
                      </div>
